...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		// Select only "relevant" hashtags, i.e., the hashtags occurring at least 100 times in the last 30s
		JavaPairDStream<String,Integer> relevantHashtags = hashtagSum.filter(new Relevant());
		JavaPairDStream<Integer,String> sumHashtagRdd=relevantHashtags.mapToPair(new Swap());
